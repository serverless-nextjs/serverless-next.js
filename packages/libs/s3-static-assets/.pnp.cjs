...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "fallbackExclusionList": [
      ["@sls-next/s3-static-assets", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
      ...
      ["@types/normalize-path", [
        ["npm:3.0.0", {
          "packageLocation": "./.yarn/cache/@types-normalize-path-npm-3.0.0-a1f250f88f-19f49b1cef.zip/node_modules/@types/normalize-path/",
          "packageDependencies": [
            ["@types/normalize-path", "npm:3.0.0"]
          ],
          "linkType": "HARD",
