...
const hasVendoredLibvips = function () {
  ...
  if (vendorPlatformId) {
    ...
    if (currentPlatformId === vendorPlatformId) {
      ...
      throw new Error(
        `'${vendorPlatformId}' binaries cannot be used on the '${currentPlatformId}' platform. Please remove the 'node_modules/sharp' directory and run 'npm install' on the '${currentPlatformId}' platform.`
      );
    }
  } else {
    return false;
