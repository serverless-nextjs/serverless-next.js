...
describe("With Trailing Slash Config Build", () => {
  ...
  describe.each`
    fixture                          | expectedOriginalNextConfig
    ${"fixture-next-config-as-obj"}  | ${'module.exports = { target: "serverless", trailingSlash: true };'}
    ${"fixture-next-config-as-func"} | ${'module.exports = () => ({ target: "serverless", trailingSlash: true });'}
  `("with fixture: $fixture", ({ fixture, expectedOriginalNextConfig }) => {
