...
module.exports = async (nextBuildDir, pluginBuildDirObj) => {
  ...
  await fse.copy(
    ...
    path.join(pluginBuildDirObj.buildDir, "./node_modules/serverless-nextjs-plugin/lib/compatLayer.js")
  );
  await fse.copy(
    path.join(__dirname, "../aws-lambda-compat.js"),
    path.join(pluginBuildDirObj.buildDir, "./node_modules/serverless-nextjs-plugin/aws-lambda-compat.js")
  );
};
