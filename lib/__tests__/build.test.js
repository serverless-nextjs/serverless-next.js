...
describe("build", () => {
  ...
  it("should call copyBuildFiles with nextBuildDir and pluginBuildDir after nextBuild finishes", () => {
    expect.assertions(1);
    ...
    return build(new PluginBuildDir(nextConfigDir)).then(() => {
      expect(copyBuildFiles).toBeCalledWith(
  ...
  it("should call getNextPagesFromBuildDir and return NextPage instances for each nextPage copied (1)", () => {
    expect.assertions(2);
  ...
  it("should call getNextPagesFromBuildDir and return NextPage instances for each nextPage copied (2)", () => {
    expect.assertions(2);
