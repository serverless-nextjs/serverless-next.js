...
| domainInputs             | `object`          | `{}`                                                               | Inputs to be passed to [domain](TODO)                                                                                                                                                                                                                                                                                                                                                            |
| domainType               | `string`          | `"both"`                                                           | Can be one of: `"apex"` - if only a domain is provided, don't create a www subdomain. `"www"` - if a 'www' subdomain is provided, don't create an apex subdomain.`"both"` - create both www and apex domains when either one is provided.                                                                                                                                                        |
