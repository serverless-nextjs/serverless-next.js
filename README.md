...
| staticDir         | \<empty\>     | Directory with static assets to be uploaded to S3. Requires a bucket provided via the `assetPrefix` described above or the `assetsBucketName` plugin config. |
