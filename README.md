...
| nextConfigDir | `string` | `.`           | Directory where your application `next.config.js` file is. This input is useful when your `serverless.yml` is not in the same directory as the next app. |
