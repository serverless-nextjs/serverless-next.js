...
| build.separateApiLambda | `boolean` | `true` | **Experimental** Set this to false to serve API routes from the default handler. Settinng to false also allows rewrites between API routes and normal page routes. Note: this is marked experimental and not fully tested, use with caution. Please report any bugs by opening an issue.
