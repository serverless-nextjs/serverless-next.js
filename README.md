...
| runtime                  | `number\|object`  | `nodejs12.x`             | When assigned a value, both the default and api lambdas will assigned memory of that value. When assigned to an object, values for the default and api lambdas can be separately defined                                                                             |  |
